...
$(document).ready(Main);
	...
	function successOfShowAll(response){
					...
					{
						var tr1=$("<tr>");
						var td1=$("<td>").text(response[i].roleid);
						tr1.append(td1);
						...
						$deleteBtn.click(clickOnDelRole);
	...
	// ///////////////////////////////////////////////////////////////
			...
			//	
			var ActionObj = {"Action":"SaveRole","Role":role,"Desc":desc};
				var settings={
				type: "POST",
				dataType: "json",
				url: "api.php",
...
<div class="formPos" style="width:400px;height:600px;border:5px solid black;background-color:white;" >
	<h3 class="chngBackgrnd" style="padding-left:60px;font-size:35">Role Managment</h3><br>
		...
		<input type="text" name="txtRole" id="txtRole" autofocus><br><br>
		...
		<input class="btn" type="button" onclick="Clear('roleform');" id="btnClear"  value="Clear">
		</div>
	</div>
</form>		
